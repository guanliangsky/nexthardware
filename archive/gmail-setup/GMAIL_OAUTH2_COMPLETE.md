...
**Local (`.env.local`):**
```
GMAIL_CLIENT_ID=139200018654-schou2gof9cgh6m0merqcslba84terps.apps.googleusercontent.com
GMAIL_CLIENT_SECRET=GOCSPX-U7P...
GMAIL_REFRESH_TOKEN=YOUR_REFRESH_TOKEN_HERE1//06gzsEX8h7mpdCgYIARAAGAYSNwF-L9IrPQPb9U-Ztu41ZOSo-6WDcmn9KHLkRdr9lSvtx9Wn0_nCSFHk-8CMylDgbeRC5B7v0Qc
GMAIL_SENDER_EMAIL=liangoptics@gmail.com
```
